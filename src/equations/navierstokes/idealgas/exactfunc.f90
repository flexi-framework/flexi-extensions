...
CALL prms%CreateIntOption(          'NumJets',      "Number of jets for active flow control on cylinder", '2')
CALL prms%CreateRealArrayOption(    'JetStrength',  "Strength of jets for active flow control on cylinder")
CALL prms%CreateRealArrayOption(    'JetAngPos',    "Angular postitions in [rad] of jets for active flow control on cylinder")
