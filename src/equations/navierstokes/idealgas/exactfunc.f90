...
CALL prms%CreateRealOption(         'JetWidth',     "Width in [rad] of jets for active flow control on cylinder", '10.')
CALL prms%CreateRealArrayOption(    'JetStrength',  "Strength of jets for active flow control on cylinder", '(/0.,0./)')
CALL prms%CreateIntegerOption(      'NumJets',      "Number of jets for active flow control on cylinder", '2')
CALL prms%CreateRealArrayOption(    'JetAngPos',    "Angular postitions in [rad] of jets for active flow control on cylinder", '(/-0.5*PP_PI,0.5*PP_PI/)')
